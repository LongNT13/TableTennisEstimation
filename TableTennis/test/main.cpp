...
string tutorial_path = "/media/long/Data1/materials/thesisM1/internshipM1/TableTennis/test/"; // path to tutorial

string img_path = tutorial_path + "Data/cam1.png";  // image to register
string ply_read_path = tutorial_path + "Data/table.ply";  // object mesh
string write_path = tutorial_path + "Data/cam1.yml";     // output file
...
int main()
{
  ...
  std::cout << "number of triangle: " << mesh.getTrianglesList().size() << std::endl;
  for (size_t i = 0; i < mesh.getNumVertices(); i++)
  {
    std::cout << "vertex " << i << ": " << mesh.getVertex(i) << std::endl;  
  }
